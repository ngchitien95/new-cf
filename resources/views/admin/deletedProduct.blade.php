        ...
        <div class="container">
            ...
            <div class="mt-2">
                <table id="tbProduct" class="table table-striped">
                    ...
                    <tr>
                        <td class="text-light bg-dark">{{$del->name}}</td>
                        <td class="text-light bg-dark">{{$del->promotion_price}}</td>
                        <td class="text-light bg-dark">
                            {{-- <a href="{{ route('cf.edit',$del->id)}}" class="btn btn-primary"><i class="fa fa-edit"></i></a> --}}
